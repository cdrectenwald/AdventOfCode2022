...
# 1) Go to https://adventofcode.com/202/day/1/input
# 2) right-click -> inspect -> click "Network".
# 3) Refresh
# 4) Click click
# 5) Click cookies
# 6) Grab the value for session. Fill it in.
SESSION = 'uTAD-lL2t6XInKQfTKQmblBRmfsvYSG5Nt8GBVmh2rpCaYyG'

useragent = 'https://github.com/cdrectenwald/AdventOfCode2022/get_input.py by cdrectenwald@gmail.com'
